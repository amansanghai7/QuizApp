package com.aman.quizapp.presentation.quiz.component
...
private fun Prev() {
    QuizOption(
        optionNumber = "A",
        options = "abcd efgh ijkl mnop qrst",
        selected = false,
        onOptionClick = {},
        onUnselectOption = {}
...
fun QuizOption(
    ...
    val startColor by transition.animateColor(
        transitionSpec = { tween(durationMillis = DefaultMarqueeDelayMillis, easing = LinearEasing) },
        label = "startColor",
    ){ selectedBox ->
